<template>
    <nav class="navbar navbar-expand-lg navbar-dark color-main fixed-top">
    <div class="container">
        ...
        <ul class="navbar-nav ml-auto" v-if="!loggedIn">
          ...
          <li class="nav-item active">
            <router-link to="/about">
               <a class="nav-link" href="">O aplikacji
            </a></router-link>
          </li>
        </ul>
        <ul class="navbar-nav ml-auto" v-if="loggedIn">
          <li class="nav-item active">
              <router-link to="/">
               <a class="nav-link" href="">Twoje grupy
            </a></router-link>
          </li>
          <li class="nav-item active">
               <router-link to="/beers">
               <a class="nav-link" href="">Baza piw
            </a></router-link>
          </li>
           <li class="nav-item active" v-if="$acl.not.check('isAdmin')">
...
export default {
  ...
  data () {
    return {
      items: [
        { id: 1, url: '/', name: 'Start' },
        { id: 2, url: '/signUp', name: 'Rejestracja' },
