			...
			<div class="modal-content">
					...
					<form>
						<div class="mb-3">
							...
							<input
								type="text"
								class="form-control"
								placeholder="Każde tylko nie wojak..."
								v-model="form.name"
							/>
						</div>
						<div class="mb-3">
							...
							<textarea
								...
								rows="3"
								placeholder="Najlepsze piwo na świecie. Ze mną się nie napijecie?!?!"
						...
						<div class="mb-3">
							<label
								for="exampleFormControlTextarea1"
								class="form-label"
								>Poziom alkoholu</label
							>
							<textarea
								class="form-control"
								id="exampleFormControlTextarea1"
								rows="3"
								placeholder="Wystarczający"
								v-model="form.alcohol_volume"
							></textarea>
						</div>
						<label
							for="exampleFormControlTextarea1"
							class="form-label"
							>Kraj pochodzenia</label
						>
						<select
				...
				<div class="modal-footer">
					...
					<button
						...
						@click="
							submitBeer(form.selectedCountry, form.selectedType)
						"
					>
						Dodaj
					</button>
